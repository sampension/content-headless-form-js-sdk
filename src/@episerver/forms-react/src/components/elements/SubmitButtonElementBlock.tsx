        ...
        <button
          ...
          className={
            isNullOrEmpty(element.properties.image)
              ? `btn btn--primary Form__Element FormExcludeDataRebind FormSubmitButton ${validatorClasses}`
              : `btn btn--primary Form__Element FormExcludeDataRebind FormSubmitButton FormImageSubmitButton ${validatorClasses}`
          }
          ref={elementRef}
        >
          {isNullOrEmpty(element.properties.image) ? (
